...
<?php endif; if(is_null($tract)){echo "<h2>Aún no existen fechas de tracto asignadas para este año o para el siguiente, comuníquese con la contraloría para más detalle.</h2>";}?>
