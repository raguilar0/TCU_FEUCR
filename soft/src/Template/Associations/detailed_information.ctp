	...
	<div class="tab-content">
		<div id="tract" class="tab-pane fade in active">
			...
			<div class="row text-left">
				<div class="col-xs-12">
					<button onclick="generatePDF('Montos de Tracto', 0, document.getElementById('tract_date'));" class="btn btn-success">Informe</button>
				</div>
		...
		<div id="surplus" class="tab-pane fade">
			...
			<div class="row text-left">
				<div class="col-xs-12">
					<button onclick="generatePDF('Montos de Superávit', 2, document.getElementById('tract_date'));" class="btn btn-success">Informe</button>
				</div>
...
<h4><strong style="text-decoration: underline;;">Cuadro de ingresos</strong></h4>
			...
			<div class="row text-left">
				<div class="col-xs-12">
					<button onclick="generatePDF('Montos de Ingresos Generados', 1, document.getElementById('tract_date'));" class="btn btn-success">Informe</button>
				</div>
