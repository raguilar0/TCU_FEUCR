...
/**
 * InitialAmountsFixture
 *
 */
class InitialAmountsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'initial_amounts_ibfk_1' => ['type' => 'foreign', 'columns' => ['association_id'], 'references' => ['associations', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
