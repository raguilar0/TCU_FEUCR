 ...
 *
 */
class AmountsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'detail' => ['type' => 'string', 'length' => 2048, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'amounts_ibfk_1' => ['type' => 'foreign', 'columns' => ['association_id'], 'references' => ['associations', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
